...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/scaffoldia/security/advisories/new)
...
- This repository (`hyperpolymath/scaffoldia`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/scaffoldia/security/advisories)
...
When using Scaffoldia, we recommend:
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/scaffoldia/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/scaffoldia/discussions) |
...
*Thank you for helping keep Scaffoldia and its users safe.* 🛡️
