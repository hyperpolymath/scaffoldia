...
* `scaffoldia` total tracked files discovered: `240`
...
| `README.adoc`
| `{{OPENSSF_PROJECT_ID}}`, `hyperpolymath`, `scaffoldia`
| resolved (2026-07-27 instantiation cure)
| README's badges now use scaffoldia's real identity (`hyperpolymath/scaffoldia`); no placeholder tokens remain.
| Closed.
